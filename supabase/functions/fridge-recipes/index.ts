...
serve(async (req) => {
  ...
  try {
    ...
    const prompt =
      ...
      "הציעי לי 3 עד 4 מתכונים פשוטים ובריאים שמשתמשים בעיקר במרכיבים האלה. " +
      range +
      "מותר להוסיף מרכיבי בסיס נפוצים (מלח, פלפל, שמן, מים, תבלינים) ולציין אותם כאופציונליים. " +
      "לכל מתכון החזירי: שם בעברית, הערכת קלוריות למנה, רשימת המרכיבים מהרשימה שלי שבהם הוא משתמש, " +
      "רשימת מרכיבים אופציונליים/נוספים, וצעדי הכנה קצרים בעברית. " +
      "העדיפי מתכונים שמשתמשים בכמה שיותר מרכיבים מהרשימה שלי.";
